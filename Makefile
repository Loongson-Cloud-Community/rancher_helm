...
LDFLAGS += -X k8s.io/helm/internal/version.metadata=${VERSION_METADATA}
...
LDFLAGS += -X k8s.io/helm/pkg/lint/rules.k8sVersionMajor=$(K8S_MODULES_MAJOR_VER)
LDFLAGS += -X k8s.io/helm/pkg/lint/rules.k8sVersionMinor=$(K8S_MODULES_MINOR_VER)
LDFLAGS += -X k8s.io/helm/pkg/chartutil.k8sVersionMajor=$(K8S_MODULES_MAJOR_VER)
LDFLAGS += -X k8s.io/helm/pkg/chartutil.k8sVersionMinor=$(K8S_MODULES_MINOR_VER)
